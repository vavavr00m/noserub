...
<!-- Revision $Revision$ -->
	...
	<?php echo $this->renderElement('metanav'); ?>
		...
		<div id="footer" class="wrapper">
			<p><a href="http://noserub.com"><img src="/images/footer/noserub-logo.gif" class="noserublogo" alt="NoseRub Logo" /></a> Powered by <a title="Decentralized social networks" href="http://noserub.com">NoseRub</a></p>
		</div>
