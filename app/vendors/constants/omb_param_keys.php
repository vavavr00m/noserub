...
class OmbParamKeys {
	const LISTENEE = 'omb_listenee';
	const LISTENEE_AVATAR = 'omb_listenee_avatar';
	const LISTENEE_BIO = 'omb_listenee_bio';
	const LISTENEE_FULLNAME = 'omb_listenee_fullname';
	const LISTENEE_HOMEPAGE = 'omb_listenee_homepage';
	const LISTENEE_LICENSE = 'omb_listenee_license';
	const LISTENEE_LOCATION = 'omb_listenee_location';
