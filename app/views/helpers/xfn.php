...
class XfnHelper extends AppHelper {
    ...
    public function friendship($data) {
        ...
        return $this->radio('friendship', 0, $checked, '<em>no selection</em>', true) .
    ...
    public function geographical($data) {
        ...
        return $this->radio('geographical', 0, $checked, '<em>no selection</em>', true) .
    ...
    public function family($data) {
        ...
        return $this->radio('familiy', 0, $checked, '<em>no selection</em>', true) .
    ...
    public function physical($data) {
        ...
        return $this->radio('physical', 0, $checked, '<em>no selection</em>', true) .
