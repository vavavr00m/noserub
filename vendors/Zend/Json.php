 ...
 * @see Zend_Json_Expr
 */
App::import('Vendor', 'zend_json_expr', array('file' => 'Zend'.DS.'Json'.DS.'Expr.php'));
...
class Zend_Json
{
    ...
    public static function decode($encodedValue, $objectDecodeType = Zend_Json::TYPE_ARRAY)
    {
        ...
        App::import('Vendor', 'zend_json_decoder', array('file' => 'Zend'.DS.'Json'.DS.'Decoder.php'));
    ...
    public static function encode($valueToEncode, $cycleCheck = false, $options = array())
    {
        ...
        if(isset($options['enableJsonExprFinder'])
           && ($options['enableJsonExprFinder'] == true)
             ...
             */
            App::import('Vendor', 'zend_json_encoder', array('file' => 'Zend'.DS.'Json'.DS.'Encoder.php'));
